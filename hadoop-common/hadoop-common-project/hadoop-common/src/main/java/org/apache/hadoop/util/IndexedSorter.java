...
public interface IndexedSorter {
   ...
   */
  void sort(@Tainted IndexedSorter this, @Tainted IndexedSortable s, @Tainted int l, @Tainted int r);
   ...
   */
  void sort(@Tainted IndexedSorter this, @Tainted IndexedSortable s, @Tainted int l, @Tainted int r, @Tainted Progressable rep);
