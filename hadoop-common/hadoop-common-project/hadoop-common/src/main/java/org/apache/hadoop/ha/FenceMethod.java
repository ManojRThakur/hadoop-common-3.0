...
public interface FenceMethod {
   ...
   */
  public void checkArgs(@Tainted FenceMethod this, @Tainted String args) throws BadFencingConfigurationException;
   ...
   */
  public @Tainted boolean tryFence(@Tainted FenceMethod this, @Tainted HAServiceTarget target, @Untainted String args)
