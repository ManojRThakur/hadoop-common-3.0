...
public interface Decompressor {
   ...
   * @param len Length
   */
  public void setInput(@Tainted Decompressor this, @Tainted byte @Tainted [] b, @Tainted int off, @Tainted int len);
   ...
   */
  public @Tainted boolean needsInput(@Tainted Decompressor this);
   ...
   * @param len Length
   */
  public void setDictionary(@Tainted Decompressor this, @Tainted byte @Tainted [] b, @Tainted int off, @Tainted int len);
   ...
   */
  public @Tainted boolean needsDictionary(@Tainted Decompressor this);
   ...
   */
  public @Tainted boolean finished(@Tainted Decompressor this);
   ...
   * @throws IOException
   */
  public @Tainted int decompress(@Tainted Decompressor this, @Tainted byte @Tainted [] b, @Tainted int off, @Tainted int len) throws IOException;
   ...
   */
  public @Tainted int getRemaining(@Tainted Decompressor this);
   ...
   */
  public void reset(@Tainted Decompressor this);

  /**
   * Closes the decompressor and discards any unprocessed input.
   */
  public void end(@Tainted Decompressor this); 
}
