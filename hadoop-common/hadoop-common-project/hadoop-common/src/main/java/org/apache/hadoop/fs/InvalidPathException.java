...
public class InvalidPathException extends @Tainted HadoopIllegalArgumentException {
   ...
   */
  public @Tainted InvalidPathException(final @Tainted String path) {
   ...
   */
  public @Tainted InvalidPathException(final @Tainted String path, final @Tainted String reason) {
