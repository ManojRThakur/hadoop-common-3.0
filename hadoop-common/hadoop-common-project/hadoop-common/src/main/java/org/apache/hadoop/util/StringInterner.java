...
public class StringInterner {
   ...
   */
  private final static @Tainted Interner<@Tainted String> strongInterner;
  
  /**
   * Retains a weak reference to each string instance it has interned. 
   */
  private final static @Tainted Interner<@Tainted String> weakInterner;
   ...
   */
  public static @Tainted String strongIntern(@Tainted String sample) {
    if (sample == null) {
      return null;
    }
   ...
   */
  public static @Tainted String weakIntern(@Tainted String sample) {
    if (sample == null) {
      return null;
    }
