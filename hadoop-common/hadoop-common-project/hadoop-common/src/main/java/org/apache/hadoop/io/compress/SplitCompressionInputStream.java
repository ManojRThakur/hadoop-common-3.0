...
public abstract class SplitCompressionInputStream
    extends @Tainted CompressionInputStream {

  private @Tainted long start;
  private @Tainted long end;

  public @Tainted SplitCompressionInputStream(@Tainted InputStream in, @Tainted long start, @Tainted long end)
      throws IOException {
    super(in);
    this.start = start;
    this.end = end;
  ...
  protected void setStart(@Tainted SplitCompressionInputStream this, @Tainted long start) {
    this.start = start;
  }

  protected void setEnd(@Tainted SplitCompressionInputStream this, @Tainted long end) {
    this.end = end;
  }
   ...
   */
  public @Tainted long getAdjustedStart(@Tainted SplitCompressionInputStream this) {
    return start;
  }
   ...
   */
  public @Tainted long getAdjustedEnd(@Tainted SplitCompressionInputStream this) {
    return end;
  }
}
