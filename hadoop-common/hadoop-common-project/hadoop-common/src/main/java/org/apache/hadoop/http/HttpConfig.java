...
public class HttpConfig {
  private static @Tainted Policy policy;
  public enum Policy {
...
@Tainted  HTTPS_ONLY;
    ...
    public static @Tainted Policy fromString(@Tainted String value) {
  ...
  public static void setPolicy(@Tainted Policy policy) {
    HttpConfig.policy = policy;
  }

  public static @Tainted boolean isSecure() {
    return policy == Policy.HTTPS_ONLY;
  }

  public static @Tainted String getSchemePrefix() {
    return (isSecure()) ? "https://" : "http://";
  }

  public static @Tainted String getScheme(@Tainted Policy policy) {
