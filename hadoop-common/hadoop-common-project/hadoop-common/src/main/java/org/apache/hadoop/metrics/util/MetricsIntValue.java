...
public class MetricsIntValue extends @Tainted MetricsBase {  
   ...
   */
  public @Tainted MetricsIntValue(final @Tainted String nam, final @Tainted MetricsRegistry registry, final @Tainted String description) {
   ...
   */
  public @Tainted MetricsIntValue(final @Tainted String nam, @Tainted MetricsRegistry registry) {
   ...
   * @param newValue
   */
  public synchronized void set(@Tainted MetricsIntValue this, final @Tainted int newValue) {
    value = newValue;
    changed = true;
  }
   ...
   */
  public synchronized @Tainted int get(@Tainted MetricsIntValue this) { 
    return value;
  } 
   ...
   */
  @Override
  public synchronized void pushMetric(@Tainted MetricsIntValue this, final @Tainted MetricsRecord mr) {
    if (changed) {
      try {
