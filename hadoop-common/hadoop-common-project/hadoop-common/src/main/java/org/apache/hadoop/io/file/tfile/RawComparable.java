...
public interface RawComparable {
   ...
   */
  abstract @Tainted byte @Tainted [] buffer(@Tainted RawComparable this);
   ...
   */
  abstract @Tainted int offset(@Tainted RawComparable this);
   ...
   */
  abstract @Tainted int size(@Tainted RawComparable this);
}
