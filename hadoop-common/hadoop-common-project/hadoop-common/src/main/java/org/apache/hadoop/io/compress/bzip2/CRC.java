 ...
 */
final class CRC {
  static final @Tainted int crc32Table @Tainted [] = new int @Tainted [] { 0x00000000, 0x04c11db7, 0x09823b6e,
  ...
  void initialiseCRC(@Tainted CRC this) {
    globalCrc = 0xffffffff;
  }

  @Tainted
  int getFinalCRC(@Tainted CRC this) {
    return ~globalCrc;
  }

  @Tainted
  int getGlobalCRC(@Tainted CRC this) {
    return globalCrc;
  }

  void setGlobalCRC(@Tainted CRC this, @Tainted int newCrc) {
    globalCrc = newCrc;
  }

  void updateCRC(@Tainted CRC this, @Tainted int inCh) {
    @Tainted
  ...
  void updateCRC(@Tainted CRC this, @Tainted int inCh, @Tainted int repeat) {
    @Tainted
