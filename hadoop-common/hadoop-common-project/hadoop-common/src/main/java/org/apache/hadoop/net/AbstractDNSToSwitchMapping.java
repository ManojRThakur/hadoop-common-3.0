...
public abstract class AbstractDNSToSwitchMapping
    implements @Tainted DNSToSwitchMapping, @Tainted Configurable {
   ...
   */
  protected @Tainted AbstractDNSToSwitchMapping() {
  }
   ...
   */
  protected @Tainted AbstractDNSToSwitchMapping(@Tainted Configuration conf) {
    this.conf = conf;
  }

  @Override
  public @Tainted Configuration getConf(@Tainted AbstractDNSToSwitchMapping this) {
    return conf;
  }

  @Override
  public void setConf(@Tainted AbstractDNSToSwitchMapping this, @Tainted Configuration conf) {
    this.conf = conf;
  }
   ...
   */
  public @Tainted boolean isSingleSwitch(@Tainted AbstractDNSToSwitchMapping this) {
    return false;
  }
   ...
   */
  public @Tainted Map<@Tainted String, @Tainted String> getSwitchMap(@Tainted AbstractDNSToSwitchMapping this) {
    return null;
  }
   ...
   * debug messages.
   */
  public @Tainted String dumpTopology(@Tainted AbstractDNSToSwitchMapping this) {
    @Tainted
    Map<@Tainted String, @Tainted String> rack = getSwitchMap();
    @Tainted
    ...
    if (rack != null) {
      builder.append("Map:\n");
      @Tainted
      Set<@Tainted String> switches = new @Tainted HashSet<@Tainted String>();
      for (Map.@Tainted Entry<@Tainted String, @Tainted String> entry : rack.entrySet()) {
        builder.append("  ")
            .append(entry.getKey())
            .append(" -> ")
  ...
  protected @Tainted boolean isSingleSwitchByScriptPolicy(@Tainted AbstractDNSToSwitchMapping this) {
    return conf != null
   ...
   */
  public static @Tainted boolean isMappingSingleSwitch(@Tainted DNSToSwitchMapping mapping) {
    return mapping != null && mapping instanceof @Tainted AbstractDNSToSwitchMapping
        && ((@Tainted AbstractDNSToSwitchMapping) mapping).isSingleSwitch();
  }
