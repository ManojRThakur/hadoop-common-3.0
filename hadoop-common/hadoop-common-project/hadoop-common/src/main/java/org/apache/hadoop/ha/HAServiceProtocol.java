...
public interface HAServiceProtocol {
   ...
   */
  public static final @Tainted long versionID = 1L;
...
@Tainted  INITIALIZING("initializing"),

@Tainted  ACTIVE("active"),

@Tainted  STANDBY("standby"),

@Tainted  STOPPING("stopping");

    private @Tainted String name;

    @Tainted
    HAServiceState(@Tainted String name) {
      this.name = name;
    }

    @Override
    public @Tainted String toString(HAServiceProtocol.@Tainted HAServiceState this) {
      return name;
    }
  }
...
@Tainted  REQUEST_BY_USER,

@Tainted  REQUEST_BY_USER_FORCED,

@Tainted  REQUEST_BY_ZKFC;
  }
  ...
  public static class StateChangeRequestInfo {
    private final @Tainted RequestSource source;

    public @Tainted StateChangeRequestInfo(@Tainted RequestSource source) {
      super();
      this.source = source;
    }

    public @Tainted RequestSource getSource(HAServiceProtocol.@Tainted StateChangeRequestInfo this) {
      return source;
    }
  }
   ...
   */
  @Idempotent
  public void monitorHealth(@Tainted HAServiceProtocol this) throws HealthCheckFailedException,
   ...
   */
  @Idempotent
  public void transitionToActive(@Tainted HAServiceProtocol this, @Tainted StateChangeRequestInfo reqInfo)
                                   throws ServiceFailedException,
                                          AccessControlException,
                                          IOException;
   ...
   */
  @Idempotent
  public void transitionToStandby(@Tainted HAServiceProtocol this, @Tainted StateChangeRequestInfo reqInfo)
                                    throws ServiceFailedException,
                                           AccessControlException,
                                           IOException;
   ...
   */
  @Idempotent
  public @Tainted HAServiceStatus getServiceStatus(@Tainted HAServiceProtocol this) throws AccessControlException,
                                                   IOException;
}
