...
public abstract class MetricsSystem implements @Tainted MetricsSystemMXBean {

  @InterfaceAudience.Private
  public abstract @Tainted MetricsSystem init(@Tainted MetricsSystem this, @Tainted String prefix);
   ...
   */
  public abstract <@Tainted T extends java.lang.@Tainted Object> @Tainted T register(@Tainted MetricsSystem this, @Tainted String name, @Tainted String desc, @Tainted T source);
   ...
   * @exception MetricsException
   */
  public <@Tainted T extends java.lang.@Tainted Object> @Tainted T register(@Tainted MetricsSystem this, @Tainted T source) {
   ...
   */
  @InterfaceAudience.Private
  public abstract @Tainted MetricsSource getSource(@Tainted MetricsSystem this, @Tainted String name);
   ...
   * @exception MetricsException
   */
  public abstract <@Tainted T extends @Tainted MetricsSink>
  @Tainted
  T register(@Tainted MetricsSystem this, @Tainted String name, @Tainted String desc, @Tainted T sink);

  /**
   * Register a callback interface for JMX events
   * @param callback  the callback object implementing the MBean interface.
   */
  public abstract void register(@Tainted MetricsSystem this, @Tainted Callback callback);
   ...
   */
  public abstract void publishMetricsNow(@Tainted MetricsSystem this);
   ...
   */
  public abstract @Tainted boolean shutdown(@Tainted MetricsSystem this);
  ...
  public interface Callback {
     ...
     * Called before start()
     */
    void preStart(MetricsSystem.@Tainted Callback this);

    /**
     * Called after start()
     */
    void postStart(MetricsSystem.@Tainted Callback this);

    /**
     * Called before stop()
     */
    void preStop(MetricsSystem.@Tainted Callback this);

    /**
     * Called after stop()
     */
    void postStop(MetricsSystem.@Tainted Callback this);
  }

  /**
   * Convenient abstract class for implementing callback interface
   */
  public static abstract class AbstractCallback implements @Tainted Callback {
    @Override public void preStart(MetricsSystem.@Tainted AbstractCallback this) {}
    @Override public void postStart(MetricsSystem.@Tainted AbstractCallback this) {}
    @Override public void preStop(MetricsSystem.@Tainted AbstractCallback this) {}
    @Override public void postStop(MetricsSystem.@Tainted AbstractCallback this) {}
  }
}
