 ...
 */
public class GangliaContext31 extends @Tainted GangliaContext {
  ...
  @Override
  public void init(@Tainted GangliaContext31 this, @Tainted String contextName, @Tainted ContextFactory factory) {
  ...
  @Override
  protected void emitMetric(@Tainted GangliaContext31 this, @Tainted String name, @Tainted String type,  @Tainted String value) 
    throws IOException
  {
    if (name == null) {
