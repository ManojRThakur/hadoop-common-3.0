...
public interface Constants {
   ...
   */
  public static final @Untainted String CONFIG_VIEWFS_PREFIX = "fs.viewfs.mounttable";
 
  /**
   * Prefix for the home dir for the mount table - if not specified
   * then the hadoop default value (/user) is used.
   */
  public static final @Untainted String CONFIG_VIEWFS_HOMEDIR = "homedir";
  
  /**
   * Config variable name for the default mount table.
   */
  public static final @Untainted String CONFIG_VIEWFS_DEFAULT_MOUNT_TABLE = "default";
  
  /**
   * Config variable full prefix for the default mount table.
   */
  public static final @Untainted String CONFIG_VIEWFS_PREFIX_DEFAULT_MOUNT_TABLE =
          CONFIG_VIEWFS_PREFIX + "." + CONFIG_VIEWFS_DEFAULT_MOUNT_TABLE;
  
  /**
   * Config variable for specifying a simple link
   */
  public static final @Untainted String CONFIG_VIEWFS_LINK = "link";
  
  /**
   * Config variable for specifying a merge link
   */
  public static final @Untainted String CONFIG_VIEWFS_LINK_MERGE = "linkMerge";
  
  /**
   * Config variable for specifying a merge of the root of the mount-table
   *  with the root of another file system. 
   */
  public static final @Untainted String CONFIG_VIEWFS_LINK_MERGE_SLASH = "linkMergeSlash";

  static public final @Tainted FsPermission PERMISSION_RRR = 
    new @Tainted FsPermission((@Tainted short) 0444);
}
