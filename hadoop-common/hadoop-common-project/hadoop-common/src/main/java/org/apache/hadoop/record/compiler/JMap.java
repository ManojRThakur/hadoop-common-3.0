...
public class JMap extends @Tainted JCompType {
  
  static private @Tainted int level = 0;
  
  static private @Tainted String getLevel() { return Integer.toString(level); }
  
  static private void incrLevel() { level++; }
  
  static private void decrLevel() { level--; }
  
  static private @Tainted String getId(@Tainted String id) { return id+getLevel(); }
  
  private @Tainted JType keyType;
  private @Tainted JType valueType;
  
  class JavaMap extends @Tainted JavaCompType {
    
    @Tainted
    JType.@Tainted JavaType key;
    @Tainted
    JType.@Tainted JavaType value;
    
    @Tainted
    JavaMap(@Tainted JType.@Tainted JavaType key, @Tainted JType.@Tainted JavaType value) {
    ...
    @Override
    @Tainted
    String getTypeIDObjectString(@Tainted JMap.JavaMap this) {
    ...
    @Override
    void genSetRTIFilter(@Tainted JMap.JavaMap this, @Tainted CodeBuffer cb, @Tainted Map<@Tainted String, @Tainted Integer> nestedStructMap) {
      key.genSetRTIFilter(cb, nestedStructMap);
      value.genSetRTIFilter(cb, nestedStructMap);
    }

    @Override
    void genCompareTo(@Tainted JMap.JavaMap this, @Tainted CodeBuffer cb, @Tainted String fname, @Tainted String other) {
      @Tainted
    ...
    @Override
    void genReadMethod(@Tainted JMap.JavaMap this, @Tainted CodeBuffer cb, @Tainted String fname, @Tainted String tag, @Tainted boolean decl) {
      if (decl) {
    ...
    @Override
    void genWriteMethod(@Tainted JMap.JavaMap this, @Tainted CodeBuffer cb, @Tainted String fname, @Tainted String tag) {
      @Tainted
    ...
    @Override
    void genSlurpBytes(@Tainted JMap.JavaMap this, @Tainted CodeBuffer cb, @Tainted String b, @Tainted String s, @Tainted String l) {
      cb.append("{\n");
      incrLevel();
    ...
    @Override
    void genCompareBytes(@Tainted JMap.JavaMap this, @Tainted CodeBuffer cb) {
      cb.append("{\n");
      incrLevel();
  ...
  class CppMap extends @Tainted CppCompType {
    
    @Tainted
    JType.@Tainted CppType key;
    @Tainted
    JType.@Tainted CppType value;
    
    @Tainted
    CppMap(@Tainted JType.@Tainted CppType key, @Tainted JType.@Tainted CppType value) {
    ...
    @Override
    @Tainted
    String getTypeIDObjectString(@Tainted JMap.CppMap this) {
    ...
    @Override
    void genSetRTIFilter(@Tainted JMap.CppMap this, @Tainted CodeBuffer cb) {
  ...
  public @Tainted JMap(@Tainted JType t1, @Tainted JType t2) {
    setJavaType(new @Tainted JavaMap(t1.getJavaType(), t2.getJavaType()));
    setCppType(new @Tainted CppMap(t1.getCppType(), t2.getCppType()));
  ...
  @Override
  @Tainted
  String getSignature(@Tainted JMap this) {
