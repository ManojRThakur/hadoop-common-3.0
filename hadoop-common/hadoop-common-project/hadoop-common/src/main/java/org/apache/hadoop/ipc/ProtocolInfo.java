...
public @interface ProtocolInfo {
  @Tainted
  String protocolName(@Tainted ProtocolInfo this);  // the name of the protocol (i.e. rpc service)
  @Tainted
  long protocolVersion(@Tainted ProtocolInfo this) default -1; // default means not defined use old way
}
