...
public class HadoopIllegalArgumentException extends @Tainted IllegalArgumentException {
   ...
   */
  public @Tainted HadoopIllegalArgumentException(final @Tainted String message) {
    super(message);
  }
}
