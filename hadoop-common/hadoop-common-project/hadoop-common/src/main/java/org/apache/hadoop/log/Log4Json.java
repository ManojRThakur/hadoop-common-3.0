 ...
 * </pre>
 */
public class Log4Json extends @Tainted Layout {
   ...
   */
  private static final @Tainted JsonFactory factory = new @Tainted MappingJsonFactory();
  public static final @Tainted String DATE = "date";
  public static final @Tainted String EXCEPTION_CLASS = "exceptionclass";
  public static final @Tainted String LEVEL = "level";
  public static final @Tainted String MESSAGE = "message";
  public static final @Tainted String NAME = "name";
  public static final @Tainted String STACK = "stack";
  public static final @Tainted String THREAD = "thread";
  public static final @Tainted String TIME = "time";
  public static final @Tainted String JSON_TYPE = "application/json";

  private final @Tainted DateFormat dateFormat;

  public @Tainted Log4Json() {
    dateFormat = new @Tainted ISO8601DateFormat();
  }
   ...
   */
  @Override
  public @Tainted String getContentType(@Tainted Log4Json this) {
    return JSON_TYPE;
  }

  @Override
  public @Tainted String format(@Tainted Log4Json this, @Tainted LoggingEvent event) {
    try {
      return toJson(event);
   ...
   */
  public @Tainted String toJson(@Tainted Log4Json this, @Tainted LoggingEvent event) throws IOException {
    @Tainted
   ...
   * @throws IOException on problems generating the JSON
   */
  public @Tainted Writer toJson(@Tainted Log4Json this, final @Tainted Writer writer, final @Tainted LoggingEvent event)
      throws IOException {
    @Tainted
   ...
   */
  public @Tainted Writer toJson(@Tainted Log4Json this, final @Tainted Writer writer,
                       final @Tainted String loggerName,
                       final @Tainted long timeStamp,
                       final @Tainted String level,
                       final @Tainted String threadName,
                       final @Tainted String message,
                       final @Tainted ThrowableInformation ti) throws IOException {
    @Tainted
    ...
    @Tainted
    Date date = new @Tainted Date(timeStamp);
    ...
    if (ti != null) {
      ...
      @Tainted
      String @Tainted [] stackTrace = ti.getThrowableStrRep();
      json.writeArrayFieldStart(STACK);
      for (@Tainted String row : stackTrace) {
   ...
   */
  @Override
  public @Tainted boolean ignoresThrowable(@Tainted Log4Json this) {
    return false;
  }
   ...
   */
  @Override
  public void activateOptions(@Tainted Log4Json this) {
  }
   ...
   */
  public static @Tainted ContainerNode parse(@Tainted String json) throws IOException {
    @Tainted
    ObjectMapper mapper = new @Tainted ObjectMapper(factory);
    @Tainted
    JsonNode jsonNode = mapper.readTree(json);
    if (!(jsonNode instanceof @Tainted ContainerNode)) {
      throw new @Tainted IOException("Wrong JSON data: " + json);
    }
    return (@Tainted ContainerNode) jsonNode;
  }
}
