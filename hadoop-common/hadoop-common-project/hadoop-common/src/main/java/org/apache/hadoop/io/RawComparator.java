...
public interface RawComparator<@Tainted T extends java.lang.@Tainted Object> extends @Tainted Comparator<T> {
   ...
   */
  public @Tainted int compare(@Tainted RawComparator<T> this, @Tainted byte @Tainted [] b1, @Tainted int s1, @Tainted int l1, @Tainted byte @Tainted [] b2, @Tainted int s2, @Tainted int l2);
