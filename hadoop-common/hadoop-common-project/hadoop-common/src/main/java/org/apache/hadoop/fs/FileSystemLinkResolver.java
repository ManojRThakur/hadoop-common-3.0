...
public abstract class FileSystemLinkResolver<@Tainted T extends java.lang.@Tainted Object> {
   ...
   */
  abstract public @Tainted T doCall(@Tainted FileSystemLinkResolver<T> this, final @Tainted Path p) throws IOException,
   ...
   * @throws IOException
   */
  abstract public @Tainted T next(@Tainted FileSystemLinkResolver<T> this, final @Tainted FileSystem fs, final @Tainted Path p) throws IOException;
   ...
   * @throws IOException
   */
  public @Tainted T resolve(@Tainted FileSystemLinkResolver<T> this, final @Tainted FileSystem filesys, final @Tainted Path path)
      throws IOException {
    @Tainted
    int count = 0;
    T in = null;
