...
public interface HasEnhancedByteBufferAccess {
   ...
   */
  public @Tainted ByteBuffer read(@Tainted HasEnhancedByteBufferAccess this, @Tainted ByteBufferPool factory, @Tainted int maxLength,
      @Tainted
   ...
   */
  public void releaseBuffer(@Tainted HasEnhancedByteBufferAccess this, @Tainted ByteBuffer buffer);
}