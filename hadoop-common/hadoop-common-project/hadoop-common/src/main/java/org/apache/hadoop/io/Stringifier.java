...
public interface Stringifier<@Tainted T extends java.lang.@Tainted Object> extends java.io.Closeable {
   ...
   */
  public @Tainted String toString(@Tainted Stringifier<T> this, @Tainted T obj)  throws IOException;
   ...
   */
  public @Tainted T fromString(@Tainted Stringifier<T> this, @Tainted String str) throws IOException;
   ...
   * */
  @Override
  public void close(@Tainted Stringifier<T> this) throws IOException;
