...
public interface MetricsRecord {
   ...
   */
  @Tainted
  long timestamp(@Tainted MetricsRecord this);

  /**
   * @return the metrics record name
   */
  @Tainted
  String name(@Tainted MetricsRecord this);

  /**
   * @return the description of the metrics record
   */
  @Tainted
  String description(@Tainted MetricsRecord this);

  /**
   * @return the context name of the metrics record
   */
  @Tainted
  String context(@Tainted MetricsRecord this);
   ...
   */
  @Tainted
  Collection<@Tainted MetricsTag> tags(@Tainted MetricsRecord this);
   ...
   */
  @Tainted
  Iterable<@Tainted AbstractMetric> metrics(@Tainted MetricsRecord this);
}
