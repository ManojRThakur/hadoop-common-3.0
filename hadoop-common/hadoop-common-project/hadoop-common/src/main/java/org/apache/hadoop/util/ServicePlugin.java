...
public interface ServicePlugin extends @Tainted Closeable {
   ...
   */
  void start(@Tainted ServicePlugin this, @Tainted Object service);
  
  /**
   * This method is invoked when the service instance is about to be shut down.
   */
  void stop(@Tainted ServicePlugin this);
}
