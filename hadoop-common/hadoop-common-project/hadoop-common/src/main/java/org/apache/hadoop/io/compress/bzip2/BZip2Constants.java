...
public interface BZip2Constants {
   ...
   */
  public static final @Tainted int END_OF_BLOCK = -2;
  /**
   * End of BZip2 stream.
   */
  public static final @Tainted int END_OF_STREAM = -1;
  ...
  * </p>
  */
  final @Tainted int @Tainted [] rNums = new int @Tainted [] { 619, 720, 127, 481, 931, 816, 813, 233, 566, 247,
