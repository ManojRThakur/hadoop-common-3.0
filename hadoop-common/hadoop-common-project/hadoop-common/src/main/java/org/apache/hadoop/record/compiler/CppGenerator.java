 ...
 */
class CppGenerator extends @Tainted CodeGenerator {
   ...
   */
  @Override
  void genCode(@Tainted CppGenerator this, @Tainted String name, @Tainted ArrayList<@Tainted JFile> ilist,
               @Tainted
    ...
    @Tainted
    FileWriter cc = new @Tainted FileWriter(name+".cc");
    try {
      @Tainted
      FileWriter hh = new @Tainted FileWriter(name+".hh");
      
      try {
        @Tainted
        String fileName = (new @Tainted File(name)).getName();
