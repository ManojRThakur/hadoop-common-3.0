...
@Tainted  DEFAULT,  @Tainted  COUNTER,  @Tainted  GAUGE,  @Tainted  TAG
  }
   ...
   */
  @Tainted
  String @Tainted [] value(@Tainted Metric this) default {};

  /**
   * @return optional description of the metric
   */
  @Tainted
  String about(@Tainted Metric this) default "";

  /**
   * @return optional sample name for MutableStat/Rate/Rates
   */
  @Tainted
  String sampleName(@Tainted Metric this) default "Ops";

  /**
   * @return optional value name for MutableStat/Rate/Rates
   */
  @Tainted
  String valueName(@Tainted Metric this) default "Time";

  /**
   * @return true to create a metric snapshot even if unchanged.
   */
  @Tainted
  boolean always(@Tainted Metric this) default false;

  /**
   * @return optional type (counter|gauge) of the metric
   */
  @Tainted
  Type type(@Tainted Metric this) default Type.DEFAULT;
}
