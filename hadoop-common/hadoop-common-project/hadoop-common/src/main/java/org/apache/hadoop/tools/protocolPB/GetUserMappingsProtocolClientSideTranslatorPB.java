...
public class GetUserMappingsProtocolClientSideTranslatorPB implements
    @Tainted
    ProtocolMetaInterface, @Tainted GetUserMappingsProtocol, @Tainted Closeable {

  /** RpcController is not used and hence is set to null */
  private final static @Tainted RpcController NULL_CONTROLLER = null;
  private final @Tainted GetUserMappingsProtocolPB rpcProxy;
  
  public @Tainted GetUserMappingsProtocolClientSideTranslatorPB(
      @Tainted
  ...
  @Override
  public void close(@Tainted GetUserMappingsProtocolClientSideTranslatorPB this) throws IOException {
    RPC.stopProxy(rpcProxy);
  }

  @Override
  public @Tainted String @Tainted [] getGroupsForUser(@Tainted GetUserMappingsProtocolClientSideTranslatorPB this, @Tainted String user) throws IOException {
    @Tainted
    ...
    return resp.getGroupsList().toArray(new @Tainted String @Tainted [resp.getGroupsCount()]);
  }

  @Override
  public @Tainted boolean isMethodSupported(@Tainted GetUserMappingsProtocolClientSideTranslatorPB this, @Tainted String methodName) throws IOException {
