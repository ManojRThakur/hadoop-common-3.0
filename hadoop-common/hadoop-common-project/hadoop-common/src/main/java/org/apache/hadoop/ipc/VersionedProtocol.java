...
public interface VersionedProtocol {
   ...
   */
  public @Tainted long getProtocolVersion(@Tainted VersionedProtocol this, @Tainted String protocol,
                                 @Tainted
   ...
   */
  public @Tainted ProtocolSignature getProtocolSignature(@Tainted VersionedProtocol this, @Tainted String protocol, 
                                 @Tainted
                                 long clientVersion,
                                 @Tainted
