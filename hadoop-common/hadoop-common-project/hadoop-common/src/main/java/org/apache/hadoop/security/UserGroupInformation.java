...
public class UserGroupInformation {
   ...
   */
  public static @Tainted boolean isSecurityEnabled() {
  ...
  private static class HadoopConfiguration 
    ...
    static {
      ...
      @Untainted String ticketCache = System.getenv("KRB5CCNAME");
      if (ticketCache != null) {
        if (IBM_JAVA) {
   ...
   */
  public @Tainted boolean hasKerberosCredentials(@Tainted UserGroupInformation this) {
  ...
  @InterfaceStability.Evolving
  public synchronized
  static @Tainted UserGroupInformation getCurrentUser() throws IOException {
   ...
   */ 
  public static @Tainted UserGroupInformation getBestUGI(
      @Untainted String ticketCachePath, @Tainted String user) throws IOException {
  ...
  public static UserGroupInformation getUGIFromTicketCache(
            @Untainted String ticketCache, String user) throws IOException {
    if (!isAuthenticationMethodEnabled(AuthenticationMethod.KERBEROS)) {
  ...
  @InterfaceStability.Evolving
  public synchronized 
  static @Tainted UserGroupInformation getLoginUser() throws IOException {
    if (loginUser == null) {
      ensureInitialized();
      try {
  ...
  @InterfaceStability.Evolving
  public synchronized
  static void loginUserFromKeytab(@Tainted String user,
                                  @Tainted
                                  String path
                                  ) throws IOException {
    if (!isSecurityEnabled())
  ...
  @InterfaceAudience.Public
  @InterfaceStability.Evolving
  public synchronized void reloginFromKeytab(@Tainted UserGroupInformation this)
  throws IOException {
    if (!isSecurityEnabled() ||
         user.getAuthenticationMethod() != AuthenticationMethod.KERBEROS ||
         !isKeytab)
  ...
  @InterfaceAudience.Public
  @InterfaceStability.Evolving
  public synchronized void reloginFromTicketCache(@Tainted UserGroupInformation this)
  throws IOException {
    if (!isSecurityEnabled() || 
        user.getAuthenticationMethod() != AuthenticationMethod.KERBEROS ||
        !isKrbTkt)
  ...
  @InterfaceAudience.Public
  @InterfaceStability.Evolving
  public synchronized static @Tainted boolean isLoginKeytabBased() throws IOException {
  ...
  @InterfaceAudience.Public
  @InterfaceStability.Evolving
  public static @Tainted UserGroupInformation createRemoteUser(@Tainted String user) {
  ...
  public static enum AuthenticationMethod {
    ...
    private final @Untainted String loginAppName;
    
    private AuthenticationMethod(AuthMethod authMethod) {
      this(authMethod, null);
    }
    private AuthenticationMethod(AuthMethod authMethod, @Untainted String loginAppName) {
      this.authMethod = authMethod;
      this.loginAppName = loginAppName;
    }
    
    public @Tainted AuthMethod getAuthMethod(UserGroupInformation.@Tainted AuthenticationMethod this) {
      return authMethod;
    }
  ...
  @InterfaceAudience.Public
  @InterfaceStability.Evolving
  public static @Tainted UserGroupInformation createProxyUser(@Tainted String user,
      @Tainted
  ...
  @InterfaceAudience.Public
  @InterfaceStability.Evolving
  public @Tainted UserGroupInformation getRealUser(@Tainted UserGroupInformation this) {
   ...
   */
  public @Tainted String getShortUserName(@Tainted UserGroupInformation this) {
  ...
  @InterfaceAudience.Public
  @InterfaceStability.Evolving
  public @Untainted String getUserName(@Tainted UserGroupInformation this) {
    return user.getName();
  }
   ...
   */
  public synchronized @Tainted boolean addTokenIdentifier(@Tainted UserGroupInformation this, @Tainted TokenIdentifier tokenId) {
  ...
  public synchronized
  @Tainted
  Collection<@Tainted Token<@Tainted ? extends @Tainted TokenIdentifier>> getTokens(@Tainted UserGroupInformation this) {
   ...
   */
  public synchronized void addCredentials(@Tainted UserGroupInformation this, @Tainted Credentials credentials) {
   ...
   */
  public synchronized @Untainted String @Tainted [] getGroupNames(@Tainted UserGroupInformation this) {
    ensureInitialized();
    try {
      List<@Untainted String> result = groups.getGroups(getShortUserName());
      return result.toArray(new @Untainted String[result.size()]);
    } catch (IOException ie) {
   ...
   */
  @Override
  public @Tainted String toString(@Tainted UserGroupInformation this) {
   ...
   */
  public synchronized 
  void setAuthenticationMethod(@Tainted UserGroupInformation this, @Tainted AuthenticationMethod authMethod) {
   ...
   * @param authMethod
   */
  public void setAuthenticationMethod(@Tainted UserGroupInformation this, @Tainted AuthMethod authMethod) {
   ...
   * @return AuthenticationMethod in the subject, null if not present.
   */
  public synchronized @Tainted AuthenticationMethod getRealAuthenticationMethod(@Tainted UserGroupInformation this) {
   ...
   */
  @Override
  public @Tainted boolean equals(@Tainted UserGroupInformation this, @Tainted Object o) {
    if (o == this) {
      return true;
    } else if (o == null || getClass() != o.getClass()) {
      return false;
   ...
   */
  @Override
  public @Tainted int hashCode(@Tainted UserGroupInformation this) {
  ...
  @InterfaceAudience.Public
  @InterfaceStability.Evolving
  public <@Tainted T extends java.lang.@Tainted Object> @Tainted T doAs(@Tainted UserGroupInformation this, @Tainted PrivilegedAction<@Tainted T> action) {
  ...
  @InterfaceAudience.Public
  @InterfaceStability.Evolving
  public <@Tainted T extends java.lang.@Tainted Object> @Tainted T doAs(@Tainted UserGroupInformation this, @Tainted PrivilegedExceptionAction<@Tainted T> action
