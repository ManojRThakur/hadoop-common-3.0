...
public abstract class PolicyProvider {
   ...
   */
  public static final @Tainted String POLICY_PROVIDER_CONFIG = 
    "hadoop.security.authorization.policyprovider";
  
  /**
   * A default {@link PolicyProvider} without any defined services.
   */
  public static final @Tainted PolicyProvider DEFAULT_POLICY_PROVIDER =
    new @Tainted PolicyProvider() {
    @Override
    public @Tainted Service @Tainted [] getServices() {
      return null;
    }
  };
   ...
   */
  public abstract @Tainted Service @Tainted [] getServices(@Tainted PolicyProvider this);
}
