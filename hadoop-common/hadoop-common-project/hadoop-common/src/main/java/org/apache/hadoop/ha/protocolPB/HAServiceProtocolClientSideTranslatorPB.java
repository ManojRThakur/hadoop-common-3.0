...
public class HAServiceProtocolClientSideTranslatorPB implements
    @Tainted
    HAServiceProtocol, @Tainted Closeable, @Tainted ProtocolTranslator {
  /** RpcController is not used and hence is set to null */
  private final static @Tainted RpcController NULL_CONTROLLER = null;
  private final static @Tainted MonitorHealthRequestProto MONITOR_HEALTH_REQ = 
      MonitorHealthRequestProto.newBuilder().build();
  private final static @Tainted GetServiceStatusRequestProto GET_SERVICE_STATUS_REQ = 
      GetServiceStatusRequestProto.newBuilder().build();
  
  private final @Tainted HAServiceProtocolPB rpcProxy;

  public @Tainted HAServiceProtocolClientSideTranslatorPB(@Tainted InetSocketAddress addr,
      @Tainted
  ...
  public @Tainted HAServiceProtocolClientSideTranslatorPB(
      @Tainted
  ...
  @Override
  public void monitorHealth(@Tainted HAServiceProtocolClientSideTranslatorPB this) throws IOException {
    try {
  ...
  @Override
  public void transitionToActive(@Tainted HAServiceProtocolClientSideTranslatorPB this, @Tainted StateChangeRequestInfo reqInfo) throws IOException {
    try {
      @Tainted
  ...
  @Override
  public void transitionToStandby(@Tainted HAServiceProtocolClientSideTranslatorPB this, @Tainted StateChangeRequestInfo reqInfo) throws IOException {
    try {
      @Tainted
  ...
  @Override
  public @Tainted HAServiceStatus getServiceStatus(@Tainted HAServiceProtocolClientSideTranslatorPB this) throws IOException {
    @Tainted
    ...
    @Tainted
    HAServiceStatus ret = new @Tainted HAServiceStatus(
  ...
  private @Tainted HAServiceState convert(@Tainted HAServiceProtocolClientSideTranslatorPB this, @Tainted HAServiceStateProto state) {
    switch(state) {
    case ACTIVE:
  ...
  private @Tainted HAStateChangeRequestInfoProto convert(@Tainted HAServiceProtocolClientSideTranslatorPB this, @Tainted StateChangeRequestInfo reqInfo) {
    @Tainted
    HARequestSource src;
    ...
    case REQUEST_BY_ZKFC:
      ...
      break;
    default:
      throw new @Tainted IllegalArgumentException("Bad source: " + reqInfo.getSource());
    }
  ...
  @Override
  public void close(@Tainted HAServiceProtocolClientSideTranslatorPB this) {
    RPC.stopProxy(rpcProxy);
  }

  @Override
  public @Tainted Object getUnderlyingProxyObject(@Tainted HAServiceProtocolClientSideTranslatorPB this) {
    return rpcProxy;
  }
}
