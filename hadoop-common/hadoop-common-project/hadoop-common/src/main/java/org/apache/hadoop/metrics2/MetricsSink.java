...
public interface MetricsSink extends @Tainted MetricsPlugin {
  /**
   * Put a metrics record in the sink
   * @param record  the record to put
   */
  void putMetrics(@Tainted MetricsSink this, @Tainted MetricsRecord record);

  /**
   * Flush any buffered metrics
   */
  void flush(@Tainted MetricsSink this);
}
