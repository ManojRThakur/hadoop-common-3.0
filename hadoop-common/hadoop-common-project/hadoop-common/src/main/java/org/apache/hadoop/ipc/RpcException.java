 ...
 */
public class RpcException extends @Tainted IOException {
   ...
   */
  @Tainted
  RpcException(final @Tainted String message) {
    super(message);
  }
   ...
   */
  @Tainted
  RpcException(final @Tainted String message, final @Tainted Throwable cause) {
    super(message, cause);
  }
}
