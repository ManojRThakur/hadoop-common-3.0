...
public class JniBasedUnixGroupsNetgroupMapping
  extends @Tainted JniBasedUnixGroupsMapping {
  
  private static final @Tainted Log LOG = LogFactory.getLog(
    JniBasedUnixGroupsNetgroupMapping.class);

  native @Untainted String @Tainted [] getUsersForNetgroupJNI(@Tainted JniBasedUnixGroupsNetgroupMapping this, @Untainted String group);
   ...
   */
  @Override
  public @Tainted List<@Untainted String> getGroups(@Tainted JniBasedUnixGroupsNetgroupMapping this, @Untainted String user) throws IOException {
   ...
   */
  @Override
  public void cacheGroupsRefresh(@Tainted JniBasedUnixGroupsNetgroupMapping this) throws IOException {
    @Tainted
   ...
   */
  @Override
  public void cacheGroupsAdd(@Tainted JniBasedUnixGroupsNetgroupMapping this, @Tainted List<@Untainted String> groups) throws IOException {
  ...
  protected synchronized @Tainted List<@Untainted String> getUsersForNetgroup(@Tainted JniBasedUnixGroupsNetgroupMapping this, @Untainted String netgroup) {
    @Untainted String @Tainted [] users = null;
    try {
      // JNI code does not expect '@' at the begining of the group name
      users = getUsersForNetgroupJNI( (@Untainted String) netgroup.substring(1));
    ...
    return new @Tainted LinkedList<@Untainted String>();
  }
}
