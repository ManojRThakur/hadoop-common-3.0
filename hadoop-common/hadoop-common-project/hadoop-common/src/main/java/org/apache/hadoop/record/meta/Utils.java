...
public class Utils {
   ...
   */
  public static void skip(@Tainted RecordInput rin, @Tainted String tag, @Tainted TypeID typeID) throws IOException {
    ...
    case TypeID.RIOType.MAP: 
      ...
      @Tainted
      MapTypeID mtID = (@Tainted MapTypeID) typeID;
    ...
    case TypeID.RIOType.STRUCT:
      ...
      @Tainted
      StructTypeID stID = (@Tainted StructTypeID) typeID;
      @Tainted
      Iterator<@Tainted FieldTypeInfo> it = stID.getFieldTypeInfos().iterator();
      while (it.hasNext()) {
        @Tainted
    ...
    case TypeID.RIOType.VECTOR: 
      ...
      @Tainted
      VectorTypeID vtID = (@Tainted VectorTypeID) typeID;
    ...
    default: 
      // shouldn't be here
      throw new @Tainted IOException("Unknown typeID when skipping bytes");
    }
  }
}
