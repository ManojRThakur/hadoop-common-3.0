...
public final class ExitUtil {
  private final static @Tainted Log LOG = LogFactory.getLog(ExitUtil.class.getName());
  private static volatile @Tainted boolean systemExitDisabled = false;
  private static volatile @Tainted boolean systemHaltDisabled = false;
  private static volatile @Tainted ExitException firstExitException;
  private static volatile @Tainted HaltException firstHaltException;

  public static class ExitException extends @Tainted RuntimeException {
    private static final @Tainted long serialVersionUID = 1L;
    public final @Tainted int status;

    public @Tainted ExitException(@Tainted int status, @Tainted String msg) {
      super(msg);
      this.status = status;
    }
  }

  public static class HaltException extends @Tainted RuntimeException {
    private static final @Tainted long serialVersionUID = 1L;
    public final @Tainted int status;

    public @Tainted HaltException(@Tainted int status, @Tainted String msg) {
      super(msg);
      this.status = status;
    }
  }
   ...
   */
  public static @Tainted boolean terminateCalled() {
   ...
   */
  public static @Tainted boolean haltCalled() {
   ...
   */
  public static @Tainted ExitException getFirstExitException() {
   ...
   */
  public static @Tainted HaltException getFirstHaltException() {
   ...
   */
  public static void terminate(@Tainted int status, @Tainted String msg) throws ExitException {
    LOG.info("Exiting with status " + status);
    if (systemExitDisabled) {
      @Tainted
      ExitException ee = new @Tainted ExitException(status, msg);
   ...
   */
  public static void halt(@Tainted int status, @Tainted String msg) throws HaltException {
    LOG.info("Halt with status " + status + " Message: " + msg);
    if (systemHaltDisabled) {
      @Tainted
      HaltException ee = new @Tainted HaltException(status, msg);
   ...
   *           if System.exit is disabled for test purposes
   */
  public static void terminate(@Tainted int status, @Tainted Throwable t) throws ExitException {
   ...
   * @throws ExitException
   */
  public static void halt(@Tainted int status, @Tainted Throwable t) throws HaltException {
   ...
   *           if System.exit is disabled for test purposes
   */
  public static void terminate(@Tainted int status) throws ExitException {
   ...
   * @throws ExitException
   */
  public static void halt(@Tainted int status) throws HaltException {
