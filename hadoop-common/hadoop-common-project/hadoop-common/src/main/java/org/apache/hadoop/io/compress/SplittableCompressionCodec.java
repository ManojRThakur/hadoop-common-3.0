...
public interface SplittableCompressionCodec extends @Tainted CompressionCodec {
   ...
   */
  public enum READ_MODE {  @Tainted  CONTINUOUS,  @Tainted  BYBLOCK};
   ...
   */
  @Tainted
  SplitCompressionInputStream createInputStream(@Tainted SplittableCompressionCodec this, @Tainted InputStream seekableIn,
      @Tainted
