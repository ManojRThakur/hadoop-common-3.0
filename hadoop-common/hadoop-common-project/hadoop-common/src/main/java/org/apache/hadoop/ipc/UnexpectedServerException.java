 ...
 * service 
 */
public class UnexpectedServerException extends @Tainted RpcException {
   ...
   */
  @Tainted
  UnexpectedServerException(final @Tainted String message) {
    super(message);
  }
   ...
   */
  @Tainted
  UnexpectedServerException(final @Tainted String message, final @Tainted Throwable cause) {
    super(message, cause);
  }
}
