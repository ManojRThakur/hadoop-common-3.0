 ...
 */
public class NativeIOException extends @Tainted IOException {
  private static final @Tainted long serialVersionUID = 1L;

  private @Tainted Errno errno;

  // Java has no unsigned primitive error code. Use a signed 32-bit
  // integer to hold the unsigned 32-bit integer.
  private @Tainted int errorCode;

  public @Tainted NativeIOException(@Tainted String msg, @Tainted Errno errno) {
    super(msg);
    this.errno = errno;
  ...
  public @Tainted NativeIOException(@Tainted String msg, @Tainted int errorCode) {
    super(msg);
    this.errorCode = errorCode;
    this.errno = Errno.UNKNOWN;
  }

  public @Tainted long getErrorCode(@Tainted NativeIOException this) {
    return errorCode;
  }

  public @Tainted Errno getErrno(@Tainted NativeIOException this) {
    return errno;
  }

  @Override
  public @Tainted String toString(@Tainted NativeIOException this) {
    if (Shell.WINDOWS)
