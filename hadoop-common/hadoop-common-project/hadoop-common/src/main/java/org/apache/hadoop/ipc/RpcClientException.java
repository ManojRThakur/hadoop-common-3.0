 ...
 */
public class RpcClientException extends @Tainted RpcException {
   ...
   */
  @Tainted
  RpcClientException(final @Tainted String message) {
    super(message);
  }
   ...
   */
  @Tainted
  RpcClientException(final @Tainted String message, final @Tainted Throwable cause) {
    super(message, cause);
  }
}
