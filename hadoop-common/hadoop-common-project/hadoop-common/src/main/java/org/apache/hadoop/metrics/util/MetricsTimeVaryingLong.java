...
public class MetricsTimeVaryingLong extends @Tainted MetricsBase{

  private static final @Tainted Log LOG =
    LogFactory.getLog("org.apache.hadoop.metrics.util");
 
  private @Tainted long currentValue;
  private @Tainted long previousIntervalValue;
   ...
   */
  public @Tainted MetricsTimeVaryingLong(final @Tainted String nam, @Tainted MetricsRegistry registry, final @Tainted String description) {
   ...
   */
  public @Tainted MetricsTimeVaryingLong(final @Tainted String nam, @Tainted MetricsRegistry registry) {
   ...
   */
  public synchronized void inc(@Tainted MetricsTimeVaryingLong this, final @Tainted long incr) {
    currentValue += incr;
  }
   ...
   * Inc metrics by one
   */
  public synchronized void inc(@Tainted MetricsTimeVaryingLong this) {
    currentValue++;
  }

  private synchronized void intervalHeartBeat(@Tainted MetricsTimeVaryingLong this) {
   ...
   */
  @Override
  public synchronized void pushMetric(@Tainted MetricsTimeVaryingLong this, final @Tainted MetricsRecord mr) {
    intervalHeartBeat();
    try {
   ...
   */
  public synchronized @Tainted long getPreviousIntervalValue(@Tainted MetricsTimeVaryingLong this) { 
   ...
   * @return prev interval value
   */
  public synchronized @Tainted long getCurrentIntervalValue(@Tainted MetricsTimeVaryingLong this) { 
    return currentValue;
  } 
}
