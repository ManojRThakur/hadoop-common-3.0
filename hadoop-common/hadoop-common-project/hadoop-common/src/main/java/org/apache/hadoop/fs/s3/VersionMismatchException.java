...
public class VersionMismatchException extends @Tainted S3FileSystemException {
  private static final @Tainted long serialVersionUID = 1L;

  public @Tainted VersionMismatchException(@Tainted String clientVersion, @Tainted String dataVersion) {
