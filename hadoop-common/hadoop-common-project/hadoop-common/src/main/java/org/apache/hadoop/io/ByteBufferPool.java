...
public interface ByteBufferPool {
   ...
   */
  @Tainted
  ByteBuffer getBuffer(@Tainted ByteBufferPool this, @Tainted boolean direct, @Tainted int length);
   ...
   */
  void putBuffer(@Tainted ByteBufferPool this, @Tainted ByteBuffer buffer);
}
