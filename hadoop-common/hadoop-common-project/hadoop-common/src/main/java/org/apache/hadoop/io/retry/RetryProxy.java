...
public class RetryProxy {
  ...
  public static <T> Object create(Class<T> iface, T implementation, RetryPolicy retryPolicy) {
    return RetryProxy.create(iface, new DefaultFailoverProxyProvider<T>(iface, implementation), retryPolicy);
  }
  ...
  public static <T> Object create(Class<T> iface, T implementation,
    ...
    return create(iface, new DefaultFailoverProxyProvider<T>(iface, implementation),
                  methodNameToPolicyMap, RetryPolicies.TRY_ONCE_THEN_FAIL);
  }
