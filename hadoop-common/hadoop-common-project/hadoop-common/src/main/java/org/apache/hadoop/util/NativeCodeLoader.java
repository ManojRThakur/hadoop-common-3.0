...
public class NativeCodeLoader {
  ...
  private static @Tainted boolean nativeCodeLoaded = false;
   ...
   */
  public static native @Tainted boolean buildSupportsSnappy();

  public static native @Tainted String getLibraryName();
   ...
   */
  public @Tainted boolean getLoadNativeLibraries(@Tainted NativeCodeLoader this, @Tainted Configuration conf) {
   ...
   */
  public void setLoadNativeLibraries(@Tainted NativeCodeLoader this, @Tainted Configuration conf, 
                                     @Tainted
