 ...
 */
public interface Reconfigurable extends @Tainted Configurable {
   ...
   */
  public @Tainted String reconfigureProperty(@Tainted Reconfigurable this, @Tainted String property, @Untainted String newVal)
   ...
   * this property.
   */
  public @Tainted boolean isPropertyReconfigurable(@Tainted Reconfigurable this, @Tainted String property);

  /**
   * Return all the properties that can be changed at run time.
   */
  public @Tainted Collection<@Tainted String> getReconfigurableProperties(@Tainted Reconfigurable this);
