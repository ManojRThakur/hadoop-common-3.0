...
public interface FailoverProxyProvider<@Tainted T extends java.lang.@Tainted Object> extends @Tainted Closeable {
   ...
   */
  public @Tainted T getProxy(@Tainted FailoverProxyProvider<T> this);
   ...
   *        failover event
   */
  public void performFailover(@Tainted FailoverProxyProvider<T> this, @Tainted T currentProxy);
   ...
   */
  public @Tainted Class<@Tainted T> getInterface(@Tainted FailoverProxyProvider<T> this);
}