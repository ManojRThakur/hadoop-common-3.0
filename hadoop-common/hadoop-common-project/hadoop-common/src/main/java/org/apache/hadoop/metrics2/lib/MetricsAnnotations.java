...
public class MetricsAnnotations {
   ...
   */
  public static @Tainted MetricsSource makeSource(@Tainted Object source) {
    return new @Tainted MetricsSourceBuilder(source,
        DefaultMetricsFactory.getAnnotatedMetricsFactory()).build();
  }

  public static @Tainted MetricsSourceBuilder newSourceBuilder(@Tainted Object source) {
    return new @Tainted MetricsSourceBuilder(source,
