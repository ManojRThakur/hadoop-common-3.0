...
public abstract class Hash {
  ...
  public static final @Tainted int INVALID_HASH = -1;
  /** Constant to denote {@link JenkinsHash}. */
  public static final @Tainted int JENKINS_HASH = 0;
  /** Constant to denote {@link MurmurHash}. */
  public static final @Tainted int MURMUR_HASH  = 1;
   ...
   */
  public static @Tainted int parseHashType(@Tainted String name) {
   ...
   * @return one of the predefined constants
   */
  public static @Tainted int getHashType(@Tainted Configuration conf) {
    @Tainted
   ...
   */
  public static @Tainted Hash getInstance(@Tainted int type) {
    switch(type) {
    case JENKINS_HASH:
   ...
   */
  public static @Tainted Hash getInstance(@Tainted Configuration conf) {
    @Tainted
   ...
   * @return hash value
   */
  public @Tainted int hash(@Tainted Hash this, @Tainted byte @Tainted [] bytes) {
   ...
   * @return hash value
   */
  public @Tainted int hash(@Tainted Hash this, @Tainted byte @Tainted [] bytes, @Tainted int initval) {
   ...
   * @return hash value
   */
  public abstract @Tainted int hash(@Tainted Hash this, @Tainted byte @Tainted [] bytes, @Tainted int length, @Tainted int initval);
}
