...
public class AccessControlException extends @Tainted IOException {
   ...
   */
  public @Tainted AccessControlException() {
   ...
   */
  public @Tainted AccessControlException(@Tainted String s) {
    super(s);
  }
   ...
   *         unknown.)
   */
  public @Tainted AccessControlException(@Tainted Throwable cause) {
    super(cause);
  }
}
