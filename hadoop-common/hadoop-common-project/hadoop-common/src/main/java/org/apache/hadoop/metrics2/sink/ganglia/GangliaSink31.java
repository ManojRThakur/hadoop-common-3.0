 ...
 *
 */
public class GangliaSink31 extends @Tainted GangliaSink30 {
   ...
   */
  @Override
  protected void emitMetric(@Tainted GangliaSink31 this, @Tainted String groupName, @Tainted String name, @Tainted String type,
      @Tainted
      String value, @Tainted GangliaConf gConf, @Tainted GangliaSlope gSlope) 
    throws IOException {
