...
public interface KeyStoresFactory extends @Tainted Configurable {
   ...
   */
  public void init(@Tainted KeyStoresFactory this, SSLFactory.@Tainted Mode mode) throws IOException, GeneralSecurityException;

  /**
   * Releases any resources being used.
   */
  public void destroy(@Tainted KeyStoresFactory this);
   ...
   */
  public @Tainted KeyManager @Tainted [] getKeyManagers(@Tainted KeyStoresFactory this);
   ...
   */
  public @Tainted TrustManager @Tainted [] getTrustManagers(@Tainted KeyStoresFactory this);
